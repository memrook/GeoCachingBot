...
Telegram бот для геокэшинга, написанный на Go. Позволяет администраторам создавать тайники с кодовыми словами, геолокациями и фотографиями, а пользователям - искать их в реальном времени с навигацией.
...
- **`caches`** - хранит информацию о тайниках
